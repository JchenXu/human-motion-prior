import numpy as np
from human_motion_prior.train.motion_prior import run_motion_prior_trainer
...
args = {}
ps = Configer(default_ps_fname='./motion_prior_defaults.ini', **args) # This is the default configuration
