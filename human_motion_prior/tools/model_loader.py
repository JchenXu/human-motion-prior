...
def load_vposer(expr_dir, vp_model='snapshot'):
    ...
    from human_motion_prior.train.vposer_smpl import VPoser, then pass VPoser to this function
...
def extract_weights_asnumpy(exp_id, vp_model= False):
    from human_motion_prior.tools.omni_tools import makepath
...
if __name__ == '__main__':
    ...
    from human_motion_prior.train.vposer_smpl import VPoser
